...
A second example, mapping the proportion of rural enterprises by region, uses the boundary file in `region-codes/`; see that directory before relying on it, as its own provenance is not yet documented in this repository.
